  ...
  <link rel="stylesheet" href="<?= base_url('theme/plugins/select2/select2.min.css')?>">
    <!-- DataTables -->
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/css/dataTables.bootstrap.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/FixedHeader-3.1.4/css/fixedHeader.dataTables.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/FixedHeader-3.1.4/css/fixedHeader.bootstrap.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Responsive-2.2.2/css/responsive.dataTables.min.css')?>">
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Responsive-2.2.2/css/responsive.bootstrap.min.css')?>">  
  <link rel="stylesheet" href="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/css/buttons.bootstrap.min.css')?>">  
  <!-- end -->
  <!-- Theme style -->
