...
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/FixedHeader-3.1.4/js/dataTables.fixedHeader.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Responsive-2.2.2/js/dataTables.responsive.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Responsive-2.2.2/js/responsive.bootstrap.min.js')?>"></script>
<!-- end -->
<!--  FOR EXPORT BUTTONS START -->
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/JSZip-2.5.0/jszip.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/pdfmake-0.1.36/pdfmake.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/pdfmake-0.1.36/vfs_fonts.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/dataTables.buttons.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/buttons.flash.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/buttons.html5.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/buttons.print.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/buttons.colVis.min.js')?>"></script>
<script src="<?= base_url('theme/plugins/DataTables-1.10.18/extensions/Buttons-1.5.4/js/buttons.bootstrap.min.js')?>"></script>
